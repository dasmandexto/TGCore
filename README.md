...
Рассылки,парсинг, инвайтинг, автоматизация. Архитектура модульная: каждый модуль —
...
открывается в браузере по адресу `http://127.0.0.1:8000`. Дашборд и страницы модулей (sidebar + авто-формы настроек из схем + консоль логов):

![Modules UI](docs/screenshots/module.png)
